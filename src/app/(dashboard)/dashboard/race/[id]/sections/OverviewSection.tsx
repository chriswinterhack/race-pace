...
type SubTab = "summary" | "course" | "logistics";
...
export function OverviewSection({ plan, onUpdate }: OverviewSectionProps) {
  ...
  // Check if logistics tab has content
  const hasLogisticsContent = race?.parking_info || race?.packet_pickup?.length ||
    race?.event_schedule?.length || race?.crew_info || race?.crew_locations?.length ||
    race?.drop_bag_info || race?.course_rules || race?.weather_notes || race?.additional_info;

  // Check if course tab has content
  const hasCourseContent = aidStations.length > 0 || race?.course_marking;
    ...
    <div className="space-y-6">
      ...
      {race?.description && (
        <div className="relative">
          ...
          <p className="text-base text-brand-navy-600 leading-relaxed pl-4">
            {race.description}
          </p>
        </div>
      )}
      ...
      {subTabs.length > 1 && (
        <div className="relative">
          {/* Background bar */}
          <div className="absolute inset-x-0 bottom-0 h-px bg-brand-navy-100" />
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "text-brand-navy-900 bg-white border border-brand-navy-100 border-b-white -mb-px"
                      : "text-brand-navy-500 hover:text-brand-navy-700 hover:bg-brand-navy-50"
                  )}
                >
                  <Icon className={cn("h-4 w-4", isActive ? "text-brand-sky-500" : "")} />
                  {tab.label}
                </button>
              );
            })}
      ...
      <div className="min-h-[400px]">
        ...
        {activeSubTab === "summary" && (
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {/* Distance Card */}
              <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-navy-900 to-brand-navy-800 p-5 text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02]">
              ...
              {distance?.elevation_gain && (
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-600 to-emerald-700 p-5 text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02]">
              ...
              <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-600 to-purple-700 p-5 text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02]">
                <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
              ...
              {distance?.time_limit_minutes ? (
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 p-5 text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02]">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
                ...
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-rose-500 to-pink-600 p-5 text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02]">
              ...
              {race?.location && (
                <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-brand-navy-50 border border-brand-navy-100">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm font-semibold text-brand-navy-900 truncate">{race.location}</p>
                  </div>
                </div>
              )}
                ...
                <div className="relative">
                  ...
                  <div className="space-y-4">
                    {aidStations.map((station, index) => (
                      ...
                      >
                        {/* Timeline dot */}
                        <div className="relative z-10 w-[54px] flex flex-col items-center flex-shrink-0">
                          <div className={cn(
                        ...
                        <div className="flex-1 pb-4">
                          <div className="p-4 rounded-xl bg-brand-navy-50 border border-brand-navy-100 group-hover:shadow-md group-hover:border-brand-sky-200 transition-all duration-200">
        ...
        {activeSubTab === "logistics" && (
          <div className="space-y-6 animate-fade-in">
            {/* Course Rules - Warning Banner at Top */}
            {race?.course_rules && (
            ...
            {/* Two-column grid for logistics cards */}
            ...
            {(race?.crew_info || (race?.crew_locations && race.crew_locations.length > 0)) && (
              <div className="rounded-2xl bg-white border border-brand-navy-100 p-6 shadow-sm">
                ...
                {race?.crew_info && (
                  <RichTextDisplay content={race.crew_info} className="text-sm text-brand-navy-700" />
                )}
              </div>
            )}
          </div>
