...
const SIZE_OPTIONS: { value: StickerSize; label: string; description: string; icon: React.ReactNode }[] = [
  { value: "compact", label: "Compact", description: '1.75" × 7"', icon: <Minimize className="h-4 w-4" /> },
  { value: "standard", label: "Standard", description: '2" × 9"', icon: <Square className="h-4 w-4" /> },
  { value: "extended", label: "Extended", description: '2.25" × 11"', icon: <Maximize className="h-4 w-4" /> },
];
